...
from xerial.round_robin_connector.AsyncRoundRobinConnector import AsyncRoundRobinConnector
...
class AsyncDBSessionPool (DBSessionPool) :
	def __init__(self, config):
		...
		if self.vendor == Vendor.POSTGRESQL :
			from xerial.session.asynchronous.AsyncPostgresDBSession import AsyncPostgresDBSession
			self.sessionInstance = AsyncPostgresDBSession
		elif self.vendor == Vendor.MARIADB or self.vendor == Vendor.MYSQL :
			from xerial.session.asynchronous.AsyncMariaDBSession import AsyncMariaDBSession
			self.sessionInstance = AsyncMariaDBSession
		elif self.vendor == Vendor.ORACLE :
			from xerial.session.asynchronous.AsyncOracleDBSession import AsyncOracleDBSession
			...
			from xerial.session.asynchronous.AsyncMSSQLDBSession import AsyncMSSQLDBSession
